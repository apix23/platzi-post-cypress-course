...
const serviceAccount = require('../config/platziposts-test-1c06d-firebase-adminsdk-yegbz-9ea1480da2.json')

firebase.initializeApp({
  credential: firebase.credential.cert(serviceAccount),
  databaseURL: 'https://platziposts-test-1c06d.firebaseio.com'
})
